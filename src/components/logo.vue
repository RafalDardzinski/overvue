...
export default {
  ...
  data() {
    return {
      primaryColor: colors.lightShades
    }
  },
  computed: {
    fillColor() {
      return this.logoFill || this.primaryColor;
    }
  },
}
</script>
